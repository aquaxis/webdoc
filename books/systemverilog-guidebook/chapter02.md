...
![シミュレータの分類と特徴](/images/systemverilog-guidebook/ch02_simulator_overview.drawio.png)
...
![コンパイルからシミュレーション実行までのワークフロー](/images/systemverilog-guidebook/ch02_workflow.drawio.png)
